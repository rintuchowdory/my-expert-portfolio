          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed">
                I build high-performance, accessible web applications with a focus on elegant user experience and robust architecture.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" className="h-12 px-8 text-lg glass-card">
                Contact Me
              </Button>
            </div>
          ...
          <div className="relative hidden lg:block animate-in zoom-in-95 duration-700">
            ...
            <div className="absolute -bottom-6 -left-6 bg-card border border-white/10 p-4 rounded-xl shadow-xl glass-card animate-bounce duration-[3000ms]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-muted-foreground uppercase font-semibold">Latest Project</div>
                  <div className="text-sm font-bold">SaaS Dashboard 2.0</div>
                </div>
              </div>
            </div>
          </div>
